...
export default function SearchedData({ searchedData }) {
    ...
    useEffect(() => {
        ...
        let url = `http://localhost:8080/h2h_milestone_3/SearchServlet?customerOrderID=${searchedData}`;
        console.log(url);
        fetch(url, {
            mode: 'cors',
            method: 'POST'
            ...
            .then((data) => {
                ...
                setSelectedColumns([modifiedData[0].id]);
            })
                ...
                <DataGrid
                    ...
                    components={{
                        Footer: (paginationProps) => (
                            <div className="MuiDataGrid-footerContainer" style={{ background: '#343534' }}>
                                <div>
